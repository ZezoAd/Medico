...
## Corpus Check
- 106 files · ~103,083 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1714 nodes · 2286 edges · 99 communities (86 shown, 13 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 18 edges (avg confidence: 0.87)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ccdb2826`
...
Cohesion: 0.03
Nodes (60): EdgeInsets, FocusNode, actionLabel, authSheetRadius, AuthTextField, _AuthTextFieldState, body, build (+52 more)
...
Cohesion: 0.06
Nodes (35): _agreedToTerms, _banner, build, _buildBanner, _buildTermsRow, cameFromSignIn, createState, dispose (+27 more)
...
Cohesion: 0.07
Nodes (28): allSpecialtiesCap, allSpecialtiesKey, build, _cache, _cachedEpoch, _capFor, _content, createState (+20 more)
...
Cohesion: 0.02
Nodes (98): AuroraPalette get, BoxBorder?, accentOnTonal, accentOnTonalDark, aurora, AuroraColors, AuroraFontSize, AuroraGradients (+90 more)

### Community 14 - "onboarding_sync_service.dart"
Cohesion: 0.05
Nodes (42): aurora_tokens.dart, dart:convert, clearPending, clearProgress, data, hasPending, _key, loadProgress (+34 more)
...
Cohesion: 0.04
Nodes (51): avgConsultMinutes, _BadgeShell, _blobControllers, _blobDurations, build, card, _ConnectionBadge, connectionStatus (+43 more)
...
Cohesion: 0.08
Nodes (25): FaIconData, home_specialty_doctors.dart, build, _chipKeys, createState, HomeSpecialtyChips, _HomeSpecialtyChipsState, icon (+17 more)
...
### Community 30 - "State"
Cohesion: 0.22
Nodes (10): _PreviewApp, _PreviewAppState, HomeScreen, _HomeScreenState, HomeTab, _HomeTabState, _PreviewApp, State (+2 more)

### Community 33 - "home_specialty_chips_test.dart"
Cohesion: 0.11
Nodes (17): package:medico/widgets/home_empty_state_card.dart, chipLabel, chipRow, connectivity, descendant, dragUntilVisible, ensureVisible, labels (+9 more)
...
Cohesion: 0.11
Nodes (19): AuthBackButton, AuthBackdrop, AuthCollapsible, AuthFieldLabel, AuthFooterPrompt, AuthGoogleButton, AuthHero, AuthInlineError (+11 more)

### Community 40 - "main.dart"
Cohesion: 0.12
Nodes (16): build, buildOverscrollIndicator, init, initializeApp, load, main, MedicoApp, _NoStretchScrollBehavior (+8 more)
...
Cohesion: 0.08
Nodes (25): ConnectivityService, _bellSize, build, connectivityService, createState, dispose, _handleBook, _handleRefresh (+17 more)
...
Cohesion: 0.18
Nodes (10): SignUpScreen, _SignUpScreenState, depth, didPop, didPush, didRemove, didReplace, main (+2 more)
...
Cohesion: 0.09
Nodes (23): BorderRadius, AuroraGradientTap, _AuroraGradientTapState, AuroraIconButton, AuroraPressable, _AuroraPressableState, AuroraPrimaryButton, AuroraSecondaryButton (+15 more)

### Community 74 - "doctor_card.dart"
Cohesion: 0.06
Nodes (32): _avatarBlockHeight, _avatarBorder, _avatarBox, _avatarOverlap, _avatarSize, _bannerHeight, _bodyHeight, _BookLabel (+24 more)
...
Cohesion: 0.29
Nodes (6): auth_test_support.dart, NavigatorState, package:medico/screens/sign_up_screen.dart, package:medico/screens/welcome_screen.dart, package:medico/theme/aurora_tokens.dart, main

### Community 78 - "onboarding_data.dart"
Cohesion: 0.15
Nodes (12): bool get, int?, arabicLabel, birthYear, city, copyWith, fromText, hasCity (+4 more)

### Community 79 - "inline_error_overflow_test.dart"
Cohesion: 0.29
Nodes (6): package:medico/screens/sign_in_screen.dart, package:medico/widgets/auth_surface.dart, budgetAndroid, main, signInSubmit, signUpSubmit
...
Cohesion: 0.08
Nodes (24): bookings_tab.dart, browse_tab.dart, ConnectivityPhase, home_tab.dart, _bookingsTabIndex, build, _connectivity, connectivityService (+16 more)
...
Cohesion: 0.09
Nodes (23): build, data, OnboardingStep1Basics, onChanged, onContinue, onSkip, _pickYear, build (+15 more)
...
## Knowledge Gaps
- **1155 isolated node(s):** `mockDoctors`, `VisitedDoctor`, `mockPreviouslyVisited`, `mockNewlyJoined`, `_doctorById` (+1150 more)
...
- **Why does `One Screen Per File Rule` connect `One Screen Per File Rule` to `otp_verification_screen.dart`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `mapAuthError` connect `_codeMessages` to `auth_error_mapper.dart`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
