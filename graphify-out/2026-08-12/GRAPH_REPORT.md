...
## Corpus Check
- 57 files · ~16,768 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 495 nodes · 617 edges · 29 communities (23 shown, 6 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 23 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6fa17e76`
...
Cohesion: 0.04
Nodes (46): _bannerRetry, _border, build, _buildBody, _buildBrand, _buildCard, _buildDigitRow, _buildForm (+38 more)

### Community 14 - "auth_error_banner.dart"
Cohesion: 0.08
Nodes (25): _amber, AuthErrorBanner, _AuthErrorBannerState, _autoDismissDelay, _autoDismissTimer, build, createState, didUpdateWidget (+17 more)
...
## Knowledge Gaps
- **264 isolated node(s):** `_OtpStatus`, `email`, `_teal`, `_ink`, `_muted` (+259 more)
