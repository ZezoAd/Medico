...
## Corpus Check
- 57 files · ~16,799 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 500 nodes · 619 edges · 28 communities (22 shown, 6 thin omitted)
...
Cohesion: 0.03
Nodes (64): _banner, _border, build, _buildBrand, _buildCard, _buildDivider, _buildFieldError, _buildForm (+56 more)
...
Cohesion: 0.03
Nodes (62): double get, _agreedToPrivacy, _banner, _border, build, _buildBrand, _buildCard, _buildDivider (+54 more)
...
## Knowledge Gaps
- **270 isolated node(s):** `DefaultFirebaseOptions`, `web`, `android`, `ios`, `macos` (+265 more)
