...
## Corpus Check
- 58 files · ~21,294 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 560 nodes · 695 edges · 28 communities (22 shown, 6 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 23 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f4330e57`
...
Cohesion: 0.03
Nodes (66): _banner, _border, build, _buildBrand, _buildCard, _buildDivider, _buildFieldError, _buildForm (+58 more)
...
Cohesion: 0.05
Nodes (43): AuthErrorSeverity, dart:async, dart:io, home_screen.dart, _bootstrap, build, _destinationForSession, fetchCurrentProfile (+35 more)
...
Cohesion: 0.06
Nodes (32): auth_error_banner.dart, _banner, _border, build, _cooldown, _cooldownSeconds, _cooldownTimer, createState (+24 more)
...
Cohesion: 0.04
Nodes (49): DateTime, _bannerRetry, _border, build, _buildBody, _buildBrand, _buildCard, _buildForm (+41 more)

### Community 14 - "auth_error_banner.dart"
Cohesion: 0.06
Nodes (35): OtpVerificationScreen, _OtpVerificationScreenState, SignInPage, _SignInPageState, SignInScreen, SignUpScreen, _SignUpScreenState, _amber (+27 more)
...
## Knowledge Gaps
- **321 isolated node(s):** `_OtpStatus`, `email`, `_teal`, `_ink`, `_muted` (+316 more)
