...
## Corpus Check
- 86 files · ~54,195 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1191 nodes · 1550 edges · 70 communities (63 shown, 7 thin omitted)
...
Cohesion: 0.04
Nodes (53): banner, build, _buildCard, _buildDivider, _buildFieldError, _buildForm, _buildGoogleButton, _buildInput (+45 more)
...
Cohesion: 0.04
Nodes (53): auth_shell.dart, double get, _agreedToPrivacy, banner, build, _buildCard, _buildDivider, _buildFieldGroup (+45 more)
...
Cohesion: 0.09
Nodes (22): AnimatedPositioned, NavigatorObserver, NeverScrollableScrollPhysics, package:medico/screens/auth_shell.dart, package:medico/widgets/auth_tab_switcher.dart, PageView, ScrollableState, depth (+14 more)
...
### Community 37 - "auth_tab_switcher.dart"
Cohesion: 0.14
Nodes (13): active, _activeInk, authTabMotionDuration, AuthTabSwitcher, build, label, labels, onSelected (+5 more)
...
Cohesion: 0.05
Nodes (37): AuthBannerSlot get, action, actionLabel, _activeBanner, AuthBannerData, AuthBannerSlot, AuthCollapsibleOnFocus, AuthGradientBackdrop (+29 more)
...
Cohesion: 0.22
Nodes (10): _PreviewApp, _PreviewApp, AuthGate, _AuthGateState, HomeEmptyStateCard, _HomeEmptyStateCardState, QueueStatusCard, _QueueStatusCardState (+2 more)
...
### Community 58 - "../models/onboarding_data.dart"
Cohesion: 0.50
...
Cohesion: 0.07
Nodes (27): home_screen.dart, build, _connectivitySub, createState, dispose, _drainPendingOnboarding, _failClosed, _fetchTimeout (+19 more)
...
## Knowledge Gaps
- **774 isolated node(s):** `AR`, `AURORA`, `C`, `S`, `R` (+769 more)
